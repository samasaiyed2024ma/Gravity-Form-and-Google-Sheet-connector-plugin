    ...
    <ol class="gfgs-guide-steps">
        ...
        <li>
            ...
            <div>
                ...
                <p><?php esc_html_e( 'Enable Google Sheets API and Google Drive API from the API Library.', 'GFGS' ); ?></p>
                <a href="https://console.cloud.google.com/apis/library/sheets.googleapis.com" target="_blank" class="gfgs-guide-link">
                    <?php esc_html_e( 'Enable Sheets API →', 'GFGS' ); ?>
                </a>
                <a href="https://console.cloud.google.com/apis/library/drive.googleapis.com" target="_blank" class="gfgs-guide-link">
        ...
        <li>
            ...
            <div>
                ...
                <p><?php esc_html_e( 'Go to APIs & Services → OAuth consent screen. Set type to External, fill in app name, and add your email as a test user.', 'GFGS' ); ?></p>
                <a href="https://console.cloud.google.com/apis/credentials/consent" target="_blank" class="gfgs-guide-link">
        ...
        <li>
            ...
            <div>
                ...
                <a href="https://console.cloud.google.com/apis/credentials" target="_blank" class="gfgs-guide-link">
